...
// FIXME: Yes there is with Pattern Matching. Let's create a ticket for refactoring this. We could also move to node config which would make life easier I suspect.
